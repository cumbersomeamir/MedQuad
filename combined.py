...
def tokenize_function(examples):
    ...
    combined_input = torch.cat((tokenized_prompt['input_ids'], tokenized_completion['input_ids']), dim=1)
    return {'input_ids': combined_input, 'attention_mask': combined_input.ne(tokenizer.pad_token_id)}
